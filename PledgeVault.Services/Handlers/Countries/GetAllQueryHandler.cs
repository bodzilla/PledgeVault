...
public sealed class GetAllQueryHandler : IRequestHandler<GetAllQuery, PaginationResponse<CountryResponse>>
{
    ...
    public async Task<PaginationResponse<CountryResponse>> Handle(GetAllQuery query, CancellationToken cancellationToken)
        => new()
        {
