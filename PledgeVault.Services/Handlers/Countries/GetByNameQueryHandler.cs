...
public sealed class GetByNameQueryHandler : IRequestHandler<GetByNameQuery, PaginationResponse<CountryResponse>>
{
    ...
    public async Task<PaginationResponse<CountryResponse>> Handle(GetByNameQuery query, CancellationToken cancellationToken)
    {
