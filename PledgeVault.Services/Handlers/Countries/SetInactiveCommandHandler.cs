...
internal sealed class SetInactiveCommandHandler : IRequestHandler<SetInactiveCommand<CountryResponse>, CountryResponse>
{
    ...
    public async Task<CountryResponse> Handle(SetInactiveCommand<CountryResponse> command, CancellationToken cancellationToken)
    {
        ...
        if (!entity.EntityActive) return _mapper.Map<CountryResponse>(entity);
