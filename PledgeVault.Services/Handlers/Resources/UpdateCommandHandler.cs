...
public sealed class UpdateCommandHandler : IRequestHandler<UpdateCommand, ResourceResponse>
{
    ...
    public async Task<ResourceResponse> Handle(UpdateCommand command, CancellationToken cancellationToken)
    {
