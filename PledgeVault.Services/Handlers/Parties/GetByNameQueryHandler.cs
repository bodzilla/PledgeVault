...
public sealed class GetByNameQueryHandler : IRequestHandler<GetByNameQuery, Page<PartyResponse>>
{
    ...
    public async Task<Page<PartyResponse>> Handle(GetByNameQuery query, CancellationToken cancellationToken)
    {
