...
public sealed class GetByCountryIdQueryHandler : IRequestHandler<GetByIdQuery, PoliticianResponse>
{
    ...
    public async Task<PoliticianResponse> Handle(GetByIdQuery query, CancellationToken cancellationToken)
    {
