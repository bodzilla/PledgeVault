...
public sealed class SetInactiveCommandHandler : IRequestHandler<SetInactiveCommand, PoliticianResponse>
{
    ...
    public async Task<PoliticianResponse> Handle(SetInactiveCommand command, CancellationToken cancellationToken)
    {
